...
ACTION_TITLES = {
    "A1": "Enable reliable Google Ads visit tracking",
    "A2": "Restore genuine conversion tracking",
    "A3": "Confirm the genuine outcome used for bidding",
    "A4": "Review and remove duplicate primary conversions",
    "A5": "Move micro-actions out of campaign bidding",
    "A6": "Align attribution for comparable primary conversions",
    "A7": "Correct the conversion values used for bidding",
    "A8": "Reconcile the main and all-conversion totals",
    "A9": "Investigate the possible tracking break",
    "B1": "Restore the main paid landing page",
    "B2": "Match the landing page to the paid intent",
    "B3": "Send paid traffic to the correct page type",
    "B4": "Repair high-traffic pages producing no outcomes",
    "C1": "Align bidding with the business goal",
    "C2": "Stabilise target bidding with enough outcome data",
    "C3": "Reset unrealistic CPA or ROAS targets",
    "C4": "Rebuild the CPA or ROAS feasibility plan",
    "C5": "Review campaigns still using manual or click bidding",
    "C6": "Stop repeated bid and target changes",
    "D1": "Recover qualified demand lost to budget",
    "D2": "Review campaigns consuming too much budget",
    "D3": "Separate incompatible shared-budget campaigns",
    "D4": "Fix ad-rank constraints before adding budget",
    "E1": "Separate brand from non-brand demand",
    "E2": "Remove Display expansion from Search campaigns",
    "E3": "Refocus spend on the account's core campaign type",
    "E4": "Control weak cold-audience spend",
    "E5": "Resolve overlapping Search demand",
    "E6": "Build a protected negative-keyword system",
    "E7": "Isolate proven ecommerce product losers",
    "E8": "Connect a qualified-lead signal to Performance Max",
    "F1": "Reduce confirmed search-term waste",
    "F2": "Review the highest-spend non-converting searches",
    "F3": "Review proven search terms for keyword promotion",
    "G1": "Resolve active ad policy restrictions",
    "G2": "Restore responsive-ad coverage",
    "G3": "Review the three poor-strength responsive ads",
    "G4": "Diagnose low Quality Score by component",
    "H1": "Investigate the inefficient device segment",
    "H2": "Investigate locations spending without outcomes",
    "H3": "Investigate the inefficient day or time block",
}
...
def _recommendation(
    ...
    *,
    ...
    return {
        ...
        "entity": ACTION_TITLES.get(str(check["id"]), check["criterion"]),
        "resource_name": "",
